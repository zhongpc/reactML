...
class QuasiRRHO:
    ...
    def get_avg_mom_inertia(self, mol):
        ...
        inertia_eigenvals = np.multiply(
            ...
            amu2kg * 1E-20).tolist()  # amu angs^2 to kg m^2
